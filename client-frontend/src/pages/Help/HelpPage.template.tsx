...
import { HelpLogicState } from './HelpPage.logic';

interface HelpTemplateProps {
  state: HelpLogicState;
}

export const HelpTemplate: React.FC<HelpTemplateProps> = ({ state }) => {
  const { searchTerm, expanded, filteredFaqs, supportOptions, setSearchTerm, setExpanded } = state;
